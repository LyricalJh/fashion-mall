...
export default function ProductDetailArea({ productId: _productId }: ProductDetailAreaProps) {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ...
      {
        // top: below header (48px mobile / 64px desktop) + tabs bar (~46px); use conservative 96px
  ...
  return (
    <section className="mt-16 border-t border-gray-200">
      ...
      <div
        ref={tabsBarRef}
        className="sticky top-12 md:top-16 z-30 border-b border-gray-200 bg-white shadow-sm"
      >
